...
public class DataLoader implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        // Limpiar las tablas espera al profeweons
        ...
        // obraTeatroRepository.deleteAll();
        ...
        // Generar Obras 
        List<ObraTeatro> obrasTeatro = obraTeatroRepository.findAll();
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Date fechaInicio = faker.date().future(30, java.util.concurrent.TimeUnit.DAYS);
            // Sumar entre 1 y 10 días a la fecha de inicio para la fecha de término
            Date fechaTermino = new Date(fechaInicio.getTime() + faker.number().numberBetween(1, 10) * 24 * 60 * 60 * 1000L);
            ...
            obra.setObraTeatro(obrasTeatro.get(random.nextInt(obrasTeatro.size())));
        ...
        for (int i = 0; i < 10; i++) {
            ...
            sala.setObra(obras.get(random.nextInt(obras.size())));
        ...
        for (int i = 0; i < 40; i++) {
            ...
            List<Character> letrasValidas = Arrays.asList('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z');
        ...
        for (int i = 0; i < 10; i++) {
            ...
            boleta.setAsiento(asientos.get(random.nextInt(asientos.size())));
