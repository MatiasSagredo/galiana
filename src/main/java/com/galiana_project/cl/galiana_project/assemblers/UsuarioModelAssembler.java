...
import com.galiana_project.cl.galiana_project.controller.UsuarioControllerV2;
...
public class UsuarioModelAssembler implements RepresentationModelAssembler<Usuario, EntityModel<Usuario>> {
    ...
    public EntityModel<Usuario> toModel(Usuario usuario) {
        return EntityModel.of(usuario,
                ...
                linkTo(methodOn(UsuarioControllerV2.class).patchUsuario(usuario.getId().longValue(), usuario)).withRel("actualizar-parcial"));
    }
}
