...
import com.galiana_project.cl.galiana_project.controller.PagoControllerV2;
...
public class PagoModelAssembler implements RepresentationModelAssembler<Pago, EntityModel<Pago>> {
    ...
    public EntityModel<Pago> toModel(Pago pago) {
        return EntityModel.of(pago,
                linkTo(methodOn(PagoControllerV2.class).getPagoById(Long.valueOf(pago.getId()))).withSelfRel(), // modo del profe
                ...
                linkTo(methodOn(PagoControllerV2.class).patchPago(pago.getId().longValue(), pago)).withRel("actualizar-parcial"));
    }
}
